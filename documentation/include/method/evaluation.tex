...
The feature extraction module, Section \ref{sec:method:proposed:features}, is described as a system that will extract the necessary feature descriptors for material evaluations on the fly\todo{on the fly?}. But to reduce the time spent evaluating the feature descriptors of the search space are extracted before all evaluations begin.
