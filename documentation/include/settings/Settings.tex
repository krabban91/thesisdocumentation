...
\newcommand{\fourfigure}[6]{
	\begin{figure}[H]
		...
		\begin{tabular}{m{0.15\textwidth}m{0.15\textwidth}m{0.15\textwidth}m{0.15\textwidth}}
			\includegraphics[width=0.14205\textwidth]{#1} &
			\includegraphics[width=0.14205\textwidth]{#2} &
			\includegraphics[width=0.14205\textwidth]{#3} &
			\includegraphics[width=0.14205\textwidth]{#4} 
		\end{tabular}
		\caption{#5}
		\label{#6}
	\end{figure}
