...
\newcommand{\fourfigure}[6]{
	\begin{figure}[H]
		\centering
		\begin{tabular}{m{0.20\textwidth}m{0.20\textwidth}m{0.20\textwidth}m{0.20\textwidth}}
			\includegraphics[width=0.19205\textwidth]{#1} &
			\includegraphics[width=0.19205\textwidth]{#2} &
			\includegraphics[width=0.19205\textwidth]{#3} &
			\includegraphics[width=0.19205\textwidth]{#4} 
		\end{tabular}
		\caption{#5}
		\label{#6}
	\end{figure}
...
\newcommand{\threefigure}[5]{
	\begin{figure}[H]
		\centering
		\begin{tabular}{m{0.3\textwidth} @{\tiny{ }} m{0.3\textwidth} @{\tiny{ }} m{0.3\textwidth} @{\tiny{ }} c}
			\includegraphics[width=0.19205\textwidth]{#1} &
			\includegraphics[width=0.29205\textwidth]{#2} &
			\includegraphics[width=0.29205\textwidth]{#3} 
		\end{tabular}
